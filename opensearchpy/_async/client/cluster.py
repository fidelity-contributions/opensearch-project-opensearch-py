...
class ClusterClient(NamespacedClient):
    ...
    async def state(
        ...
        :arg filter_path: Used to reduce the response. This parameter
            ...
            match any field or part of a field’s name. You can also exclude fields
            with "-".
        :arg flat_settings: Returns settings in a flat format. Default
            is false.
        :arg human: Whether to return human readable values for
            statistics. Default is True.
    ...
    async def stats(
        ...
        :arg filter_path: Used to reduce the response. This parameter
            ...
            match any field or part of a field’s name. You can also exclude fields
            with "-".
        :arg flat_settings: When `true`, returns settings in a flat
    ...
    async def get_settings(
        ...
        :arg filter_path: Used to reduce the response. This parameter
            ...
            match any field or part of a field’s name. You can also exclude fields
            with "-".
        :arg flat_settings: When `true`, returns cluster settings in a
    ...
    async def put_component_template(
        ...
        :arg name: The name of the component template to create.
            ...
            `synthetics-mapping`; `synthetics-settings`. OpenSearch uses these
